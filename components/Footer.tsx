        ...
        <div className="border-t border-gray-700 pt-6 sm:pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center md:items-start gap-6 md:gap-8">
            ...
            <div className="flex flex-wrap justify-center gap-4 sm:gap-6 text-velvet-gold text-sm sm:text-base order-3 md:order-2">
              <Link href="/terms" className="hover:text-white transition whitespace-nowrap">Terms</Link>
              <Link href="/privacy" className="hover:text-white transition whitespace-nowrap">Privacy</Link>
              <Link href="/cookies" className="hover:text-white transition whitespace-nowrap">Cookies</Link>
            </div>
