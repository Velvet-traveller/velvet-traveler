...
import BookNowFormModal from "@/components/modals/BookNowFormModal";
      ...
      <div className="bg-white rounded-lg overflow-hidden shadow-lg hover:shadow-xl transition-shadow duration-300 flex flex-col md:flex-row">
        ...
        <div className="p-4 md:p-6 md:pl-8 flex flex-col justify-between flex-1">
          ...
          <button
            ...
            className="w-full md:w-32 bg-[#8B6914] hover:bg-[#A67C1A] text-white py-2 rounded-lg text-sm md:text-base font-semibold transition-colors duration-300"
          >
            Book now
          </button>
        </div>
